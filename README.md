...
* Зі сторінки входу до АРКАНу: 1.3.1.45 *(завантаження здійснюється зі сторінки самого сервісу у разі відсутності у користувача встановленної або запущенної версії)* ([завантажено файлообмінник](https://mega.nz/file/PBtiQKKS#YRjxSvmtW-VHGk8zWAsGjDX2Rf2KqctgaHl9KzU14oA) 
